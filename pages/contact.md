...
<img src="{{ '/assets/img/logos/CRREL_dark_text.png' | relative_url }}" alt="CRREL logo" style="width: 50%; text-align: center; padding: 0 0; margin-left: auto; margin-right: auto;" />
